...
export const meta: MetaFunction = () => {
  return [{title: 'Fast Simon Demo For Shopify Hydrogen | Home'}];
};
      ...
      <div className={"fast-simon-banner-container"}>
        ...
        <div className="fast-simon-banner-content-container">
          <div className="fast-simon-banner-content">
            <h2 className="fast-simon-banner-title">Browse our latest products</h2>
            <div className="fast-simon-banner-btn">
